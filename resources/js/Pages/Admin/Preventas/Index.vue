    ...
    },
    {
        ...
        render: function (data, type, row) {
            ...
            if (
                ...
                props_page.auth?.user.permisos.includes("preventas.edit")
            ) {
            ...
            if (
                props_page.auth?.user.permisos == "*" ||
                props_page.auth?.user.permisos.includes("preventas.destroy")
            ) {
...
const accionesRow = () => {
    // editar
    $("#table-preventa").on("click", "button.editar", function (e) {
        e.preventDefault();
        let id = $(this).attr("data-id");
        axios.get(route("preventas.show", id)).then((response) => {
    ...
    // eliminar
    $("#table-preventa").on("click", "button.eliminar", function (e) {
        e.preventDefault();
...
<template>
    <Head title="Pre-Venta de Terrenos"></Head>

    <!-- BEGIN breadcrumb -->
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:;">Inicio</a></li>
        <li class="breadcrumb-item active">Pre-Venta de Terrenos</li>
    </ol>
    <!-- END breadcrumb -->
    <!-- BEGIN page-header -->
    <h1 class="page-header">Pre-Venta de Terrenos</h1>
    <!-- END page-header -->
