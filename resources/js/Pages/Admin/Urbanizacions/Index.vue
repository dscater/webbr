...
const { setUrbanizacion, limpiarUrbanizacion } = useUrbanizacions();
    ...
    },
    {
        ...
        render: function (data, type, row) {
            ...
            if (
                ...
                props_page.auth?.user.permisos.includes("urbanizacions.edit")
            ) {
            ...
            if (
                props_page.auth?.user.permisos == "*" ||
                props_page.auth?.user.permisos.includes("urbanizacions.destroy")
            ) {
...
<template>
    <Head title="Urbanización"></Head>

    <!-- BEGIN breadcrumb -->
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:;">Inicio</a></li>
        <li class="breadcrumb-item active">Urbanización</li>
    </ol>
    <!-- END breadcrumb -->
    <!-- BEGIN page-header -->
    <h1 class="page-header">Urbanización</h1>
    <!-- END page-header -->
