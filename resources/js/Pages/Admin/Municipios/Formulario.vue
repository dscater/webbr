...
const { oMunicipio, limpiarMunicipio } = useMunicipios();
const { axiosGet } = useAxios();
const accion = ref(props.accion_dialog);
const dialog = ref(props.open_dialog);
let form = useForm(oMunicipio.value);
watch(
    () => props.open_dialog,
    async (newValue) => {
...
const enviarFormulario = () => {
    let url =
        form["_method"] == "POST"
            ? route("municipios.store")
            : route("municipios.update", form.id);
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form @submit.prevent="enviarFormulario()">
                        <div class="row">
                            <div class="col-md-12">
                                <label>Nombre de Municipio/Ciudad*</label>
                                <input
                                    type="text"
                                    class="form-control"
                                    :class="{
