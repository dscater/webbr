    ...
    },
    {
        ...
        render: function (data, type, row) {
            ...
            if (
                ...
                props_page.auth?.user.permisos.includes("ventas.edit")
            ) {
            ...
            if (
                props_page.auth?.user.permisos == "*" ||
                props_page.auth?.user.permisos.includes("ventas.destroy")
            ) {
...
const accionesRow = () => {
    ...
    $("#table-venta").on("click", "button.editar", function (e) {
        ...
        axios.get(route("ventas.show", id)).then((response) => {
    ...
    $("#table-venta").on("click", "button.eliminar", function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let respuesta = await axiosDelete(route("ventas.destroy", id));
...
<template>
    <Head title="Venta de Terrenos"></Head>

    <!-- BEGIN breadcrumb -->
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:;">Inicio</a></li>
        <li class="breadcrumb-item active">Venta de Terrenos</li>
    </ol>
    <!-- END breadcrumb -->
    <!-- BEGIN page-header -->
    <h1 class="page-header">Venta de Terrenos</h1>
    <!-- END page-header -->
