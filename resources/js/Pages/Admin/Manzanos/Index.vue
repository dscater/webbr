...
const { setManzano, limpiarManzano } = useManzanos();
    ...
    },
    {
        ...
        render: function (data, type, row) {
            ...
            if (
                ...
                props_page.auth?.user.permisos.includes("manzanos.edit")
            ) {
            ...
            if (
                props_page.auth?.user.permisos == "*" ||
                props_page.auth?.user.permisos.includes("manzanos.destroy")
            ) {
...
onMounted(async () => {
    datatable = initDataTable("#table-manzano", columns, route("manzanos.api"));
...
<template>
    <Head title="Manzano"></Head>

    <!-- BEGIN breadcrumb -->
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:;">Inicio</a></li>
        <li class="breadcrumb-item active">Manzano</li>
    </ol>
    <!-- END breadcrumb -->
    <!-- BEGIN page-header -->
    <h1 class="page-header">Manzano</h1>
    <!-- END page-header -->
