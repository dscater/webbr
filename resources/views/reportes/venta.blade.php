    ...
    <table>
        ...
        <tbody>
            <tr class="borderbottom">
                ...
                <td>Servicio de asistencia y acompañamiento para la adquisición de equipo de computación</td>
                <td class="centreado">1</td>
                <td class="centreado">100.00</td>
                <td class="derecha">100.00</td>
            </tr>
            <tr class="borderbottom">
                <td class="centreado">2</td>
                <td>Armado de equipo e instalación de programas</td>
                <td class="centreado">1</td>
                <td class="centreado">50.00</td>
                <td class="derecha">50.00</td>
            </tr>
            <tr class="borderbottom gray">
                <td class="derecha bold font11" colspan="4">TOTAL</td>
                <td class="bold centreado derecha font11">150.00</td>
            </tr>
        </tbody>
    </table>
    <h4 class="texto2 mb-0" style="margin-bottom: 0px;">Son: Ciento cincuenta 00/100 Bolivianos</h4>
