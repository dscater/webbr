...
class TerrenoUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            "iglesias" => "required",
            "oficinas_gubernamentales" => "required",
    ...
    public function messages(): array
    {
        return [
            ...
            "oficinas_gubernamentales.required" => "Debes completar este campo",
            ...
            "imagens.requried" => "Debes agregar al menos 1 imagen"
        ];
    }
}
